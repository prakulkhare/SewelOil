...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      localStorage.setItem('userName', email);  // You can replace this with actual user data from Firebase
      localStorage.setItem('userEmail', email); // Same as above
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      // Set user data in localStorage
      localStorage.setItem('isLoggedIn', 'true');
      localStorage.setItem('userName', user.displayName); // Store actual display name
      localStorage.setItem('userEmail', user.email);      // Store actual email
