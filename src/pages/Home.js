...
const Home = () => {
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      <Header />
      {/* Hero Section */}
      <header className="bg-cover bg-center h-64 flex flex-col justify-center items-center text-white text-center"
      ...
      <section className="bg-blue-900 text-white p-8 text-center">
        ...
        <button onClick={ContactHandler} className="mt-4 bg-yellow-500 text-black px-6 py-3 rounded-lg">Contact Us</button>
      </section>
